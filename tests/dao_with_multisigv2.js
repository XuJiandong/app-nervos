describe("DAO operations", () => {
  it("DAO deposit with multisig V2", async function() {
    const flow = await flowAccept(this.speculos, [
      ...
      {header:"Cell Owner", body:"ckb1qzda0cr08m85hc8jlnfp3zer7xulejywt49kt2rr0vthywaa50xwsqgqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq5m759c"},
    ]);
  ...
  it("DAO prepare with multisig V2 passes", async function() {
    const flow = await flowAccept(this.speculos, [
      {header:"Confirm DAO", body:"Prepare"},
      {header:"Deposit Amount", body:"1000"},
      {header:"Fee", body:"0"},
      {header:"Cell Owner", body:"ckb1qzda0cr08m85hc8jlnfp3zer7xulejywt49kt2rr0vthywaa50xwsq0eq8hgemg5zw8nd394ju25h4p4swf9c4cmd5lf4"},
    ]);
  ...
  it("DAO withdrawal with multisig V2 passes", async function() {
    const flow = await flowAccept(this.speculos, [
